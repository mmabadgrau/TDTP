...
source("plotFunction.r") # Function in charge of actually painting the graphs
...
# recombinations<-c(0.0000000, 0.0000500, 0.0001000, 0.0002000, 0.0003000) #, 0.0004000)
        ...
        dataSource<-paste("resultsPowerOneBlocksimulationsDiffGeneralNewOnlyHetero", sizeT, "All", sep="")
...
if (correction==1) 
range<-c(1,3,4,5,9) else range<-c(7,8,9,24,15,16)
...
name=paste(dir, "simulations", sep="")
if (correction) name=paste(name, "Correction", sep="")
if (testModel=="PowerOneLocus")
